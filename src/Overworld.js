class Overworld extends Phaser.Scene {
    ...
    create() {
        ...
        const spawnslime = map.findObject('spawns', (obj) => obj.name === 'spawnslime')
        console.log(spawnslime)




        // add slime
        this.slime = this.physics.add.sprite(spawnslime.x, spawnslime.y, 'slime', 0)
